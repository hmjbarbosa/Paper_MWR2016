...
switch opt
 ...
 case 5
  ...
  ID='_14hr_interval_2011_2012'; tofit=0;
 case 6
...
title([strrep(tag,'_',' ')]);
prettify(gca); grid;
figname=['figs/free_' tag '_correlation_distance' ID '.png'];
print(figname,'-dpng');
...
figname=['figs/free_' tag '_angular_vs_hours' ID '.png'];
print(figname,'-dpng');
fprintf(fid,'%s\n',['\includegraphics[width=0.45\linewidth]{' figname '}']);
...
figname=['figs/free_' tag '_time_evolution_per_station' ID '.png'];
print(figname,'-dpng')
fprintf(fid,'%s\n',['\includegraphics[width=0.45\linewidth]{' figname '}']);

% fim
%tmp=datevec(datenum(2012,1,1)+X/24);
%fid=fopen('all_55_events_timestep_anomalies_OK.dat','w');
%for i=1:size(Y,1)
%  for j=1:nstation
%    if (j==13)
%      A=fwrite(fid,sprintf('%4d  %2d  %2d  %2d  %2d  %s  %.2f  %.2f  %.2f\n',...
...
prettify(gca); grid on; 
figname=['figs/free_' tag '_time_evolution_per_event' ID '.png'];
print(figname,'-dpng')
fprintf(fid,'%s\n',['\includegraphics[width=0.45\linewidth]{' figname '}']);
...
figname=['figs/free_' tag '_hist_npts' ID '.png'];
print(figname,'-dpng')
fprintf(fid,'%s\n',['\includegraphics[width=0.45\linewidth]{' figname '}']);
...
title([strrep(tag,'_',' ') ]);
prettify(gca); grid on; 
figname=['figs/free_' tag '_npts_time' ID '.png'];
print(figname,'-dpng')
fprintf(fid,'%s\n',['\includegraphics[width=0.45\linewidth]{' figname '}']);
