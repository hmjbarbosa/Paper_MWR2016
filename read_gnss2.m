...
%ifile='Dry_CTT_season_data_2011'; tag='Dry_CTT';
%ifile='Dry_PWV_season_data_2011'; tag='Dry_PWV';
%ifile='Dry_to_Wet_CTT_season_data_2011'; tag='Dry_to_Wet_CTT';
%ifile='Dry_to_Wet_PWV_season_data_2011'; tag='Dry_to_Wet_PWV';
%ifile='Wet_CTT_season_data_2012'; tag='Wet_CTT';
ifile='Wet_PWV_season_data_2012'; tag='Wet_PWV';
...
disp('saving to file...')
save([ifile '.mat'],'-v7.3','-struct','data');
