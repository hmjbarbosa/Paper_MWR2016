...
switch opt
 case 1
  tag=['All_PWV']; nevents=67; var='PWV';T0=0; ctt15clean=0; ymin=0.3;maxdist=150;
  ID='_14hr_interval_2011_2012'; step=1;
 case 2
  tag=['All_PWV']; nevents=67; var='PWV';T0=0; ctt15clean=0; ymin=0.3;maxdist=150;
  ID='_14hr_interval_2011_2012'; step=0.5;
end
...
%title([strrep(tag,'_',' ')]);
prettify(gca); grid;
figname=['figs/figure2_ALL_' num2str(step) 'h_correlation_distance'];
...
myfit=['Nonlinear fit using model:' char(10) 'Slope(t) = A + B exp(t / $\tau$)' char(10) ...
       '1 h, ' leg{1} char(10) '30 min, ' leg{2} ];
...
figname=['figs/figure3_ALL_1h_30min_angular_vs_hours'];
print([figname '.png'],'-dpng');
print([figname '.eps'],'-depsc2');
saveas(gca,[figname '.fig'],'fig');
